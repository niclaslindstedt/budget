// Legacy migrations (v1 → v30). These steps predate the v34 → v35
// Settings restructure and the achievements / theming / language
...
export const LEGACY_MIGRATIONS: MigrationTable = {
