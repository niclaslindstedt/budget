...
const items: ItemsCatalog = {
  ...
  linkedCountOne: "Kopplad till {count} transaktion",
  linkedCountOther: "Kopplad till {count} transaktioner",
  acquiredAt: "Inköpt",
  depreciates: "Skrivs av över tid",
  depreciationModel: "Avskrivningsmodell",
  depreciationSteady: "Jämn",
  depreciationAccelerated: "Accelererad",
  depreciationSteadyHint: "Tappar lika stor andel av värdet varje år.",
  depreciationAcceleratedHint:
    "Tappar värde direkt när den inte längre är ny, snabbast första året.",
  ratePerYear: "Takt per år (%)",
  ratePerYearPlaceholder: "t.ex. 20",
  initialDrop: "Direkt värdetapp (%)",
  initialDropPlaceholder: "t.ex. 20",
  firstYearRate: "Första året (%)",
  firstYearRatePlaceholder: "t.ex. 30",
  rateAfterFirstYear: "Följande år (%)",
  rateAfterFirstYearPlaceholder: "t.ex. 15",
