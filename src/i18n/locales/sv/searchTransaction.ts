...
const searchTransaction: SearchTransactionCatalog = {
  ...
  filterCompaniesAll: "Inga företag valda — söker i alla.",
  filterTypes: "Typer",
  filterTypesAll: "Inga typer valda — söker i alla.",
  filterCategories: "Kategorier",
  filterCategoriesAll: "Inga kategorier valda — söker i alla.",
  filterTags: "Taggar",
  filterTagsAll: "Inga taggar valda — söker i alla.",
