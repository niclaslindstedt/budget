...
const sheetModal = {
  ...
  carsHint:
    "The Cars sheet shows what having a car really costs — linked transport charges, value lost to depreciation, and loan interest. Add cars from there — no per-sheet account binding needed.",
  loansHint:
