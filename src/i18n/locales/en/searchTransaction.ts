...
const searchTransaction = {
  ...
  filterCompaniesAll: "No companies selected — searching all.",
  filterTypes: "Types",
  filterTypesAll: "No types selected — searching all.",
  filterCategories: "Categories",
  filterCategoriesAll: "No categories selected — searching all.",
  filterTags: "Tags",
  filterTagsAll: "No tags selected — searching all.",
