// Composed English catalog. Each top-level group lives in its own
// file under this directory; this index re-assembles them so the rest
// of the app keeps a single `en` object to import. The `Catalog`
// type is derived here, then consumed by sv/index.ts and the runtime
