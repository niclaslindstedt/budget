...
const editEntry = {
  ...
  amountModeEstimate: "Estimate",
  amountModeExactHint: "A single, known amount",
  amountModeEstimateHint: "A range — for bills that vary month to month",
  amountMin: "Minimum",
  amountEstimate: "Estimate",
  amountMax: "Maximum",
  amountMinPlaceholder: "Min",
  amountEstimatePlaceholder: "Estimate",
