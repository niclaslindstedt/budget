...
const items = {
  ...
  linkedCountOne: "Linked to {count} transaction",
  linkedCountOther: "Linked to {count} transactions",
  acquiredAt: "Acquired",
  ...
  depreciationAcceleratedHint:
    "Drops the moment it's no longer new, declines fastest the first year.",
  ratePerYear: "Rate per year (%)",
  ratePerYearPlaceholder: "e.g. 20",
  initialDrop: "Initial drop (%)",
  initialDropPlaceholder: "e.g. 20",
  firstYearRate: "First year (%)",
  firstYearRatePlaceholder: "e.g. 30",
  rateAfterFirstYear: "Following years (%)",
  rateAfterFirstYearPlaceholder: "e.g. 15",
