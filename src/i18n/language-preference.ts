...
// auth screen, the standalone routes (`/privacy`, `/schema`,
// `/changelog`), and the loading shell render in the right
// language without first decrypting the bucket. Language
// preference is not PII — leaking it is no worse than leaking the
