...
export function InstallPrompt() {
  ...
  return (
    <div
      ...
      data-toast-stack
      className="fixed inset-x-3 bottom-[var(--toast-stack-bottom)] z-[60] mx-auto flex max-w-md items-start gap-3 rounded border border-line bg-surface px-3 py-2 text-fg shadow-md"
    >
