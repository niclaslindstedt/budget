...
interface ImportMetaEnv {
  ...
  // Optional donate-button target URL. Empty / undefined hides the
  // button in Settings entirely. Not a secret (ships in the bundle);
  // routed through a GitHub Actions secret so forks don't inherit
  // the upstream maintainer's personal donate URL.
