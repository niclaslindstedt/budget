...
an item while editing it. Receipts are saved as files in a `receipts`
folder on your storage, named from a preset you choose in the **Items**
settings tab (one of them files each receipt under a folder per type),
so they're easy to find later; they stay encrypted whenever your budget
is.
