...
walks them one at a time so you can add line items, skip, or ignore an
entry for good. Tune the amount and the type filter — deselect a type
or add your own — in the new **Items** settings tab.
