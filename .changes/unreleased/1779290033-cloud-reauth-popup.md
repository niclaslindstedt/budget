...
trip runs and surfaces any failure (popup blocked, dismissed)
inline instead of swallowing it silently. A new Storage setting lets
you turn the auto-pop-up off and reconnect from the sync status icon
yourself.
