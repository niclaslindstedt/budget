...
any time to add a point to its history), and the mortgages against it.
For each mortgage you can record the sum you borrowed, the current
balance, the interest rate, how often the rate resets, when it next
