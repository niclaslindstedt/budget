...
`src/data/property-mortgage/` and `src/data/property-repairs/`.
...
| **Property settings tab**                           | `SettingsModal/tabs/properties.tsx` (`PropertiesTab`). [→](overview.md#property-settings-tab)                                                                                                                     |
| **Current value** / **value history**               | `PropertyValuePoint` (`Property.valueHistory`); `UpdatePropertyValueModal.tsx`, `addPropertyValue`. [→](overview.md#current-value-property)                                                                       |
...
| **Receipt target** / **receipt manager**            | `TxnReceiptTarget`, `resolveTxnReceipt` (`src/data/receipts/target.ts`), `useReceiptManager` (`src/components/AppShell/hooks/`). [→](overview.md#receipt-target)                                                  |
...
| **Subtype**                                                   | `Subtype` (`src/data/types/categories.ts`, `UserData.subtypes`); `SubtypesAdmin`, `itemSubtypes`. [→](overview.md#subtype)                                               |
