...
| **Property attachments**                            | `usePropertyAttachments` (`src/components/AppShell/hooks/`); the per-property `properties/` store (repair receipts + uploaded files). [→](overview.md#property-attachments)                                       |
