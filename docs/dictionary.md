...
| **Unified mortgage view** / **split view**          | `UnifiedMortgageView` (`PropertyCard.tsx`); `aggregateMortgages` (`src/data/property-mortgage/aggregate.ts`). [→](overview.md#unified-mortgage-view)                                                                                                                 |
| **Mortgage section menu**                           | `MortgageSectionMenu.tsx`. [→](overview.md#mortgage-section-menu)                                                                                                                                                                                                    |
